package com.kutayyaman.security;
...
//Bu filtreyi projeye dahil etmek icin web.xml dosyasinda degisiklikler yaptik.

@Component //springin konteynirina veriyoruz al sen kullan demek gibi bir sey.
@Scope("session")
