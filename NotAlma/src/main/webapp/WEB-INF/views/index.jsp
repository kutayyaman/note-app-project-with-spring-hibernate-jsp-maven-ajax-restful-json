...
<!DOCTYPE html>
	...
	<!-- <div style="position: fixed;width: 100%; height: 100vh;background-color: #555555; "></div>
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<ul class="fh5co-social">
				<li><a href="logout">Cikis Yap</a></li>
		...
		<div class="row fh5co-post-entry" id="list">
			...
			<%--  <c:forEach items="${notlar}" var="note">
			 	<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
					...
					<span class="fh5co-meta fh5co-date">tarih bilgisi</span>
				</article>
			 </c:forEach> --%>
